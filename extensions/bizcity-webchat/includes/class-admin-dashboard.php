...
class BizCity_WebChat_Admin_Dashboard {
    ...
    public function render_dashboard_react($theme = 'legacy') {
        ...
        $welcome_tools = apply_filters('bizcity_welcome_tools', [
            ...
            // ['slug' => 'order_list',  'pluginSlug' => 'bizcity-tool-woo',     ...] // ARCHIVED 2026-06-01 → plugins/_archived/bizcity-tool-woo/
            // ['slug' => 'report',      'pluginSlug' => 'bizcity-tool-woo',     ...] // ARCHIVED 2026-06-01 → plugins/_archived/bizcity-tool-woo/
            // ['slug' => 'mindmap',     'pluginSlug' => 'bizcity-tool-mindmap', ...] // ARCHIVED 2026-06-01 → plugins/_archived/bizcity-tool-mindmap/
