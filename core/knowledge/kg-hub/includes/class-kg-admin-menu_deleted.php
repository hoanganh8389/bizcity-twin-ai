 ...
 *
 * Canonical owner: modules/twinkg (BizCity_TwinKG_Admin_Menu + BizCity_TwinKG_Public_Page)
 *
 * The KG React app moved to modules/twinkg and is served at /twinkg/; core/knowledge keeps only REST + the BizCity_KG facade (CORE-REDUCTION-WP-09 T3, rule R-KG-UI).
 *
