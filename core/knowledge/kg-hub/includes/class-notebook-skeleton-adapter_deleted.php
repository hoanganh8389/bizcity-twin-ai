 ...
 *
 * Canonical owner: core/knowledge/kg-hub/skeleton/class-notebook-skeleton-adapter.php (the only copy kg-hub/bootstrap.php requires, lines 164-167)
 *
 * Stale duplicate declaration. Both copies declare the same class, so whichever loaded first would win; only skeleton/ is ever required. The three R-CLI-ASYNC-ISOLATION guards that lived only in this dead copy were ported to the live one first (CORE-REDUCTION-WP-01 K-01).
 *
