 ...
 *
 * Canonical owner: modules/twinchat (the /twinchat/ surface) — no replacement needed in core
 *
 * Legacy admin chat page. Its only caller was a require in core/knowledge/includes/class-admin-menu.php that has been commented out since before 2026-09; chat moved to the TwinChat surface (CORE-REDUCTION-WP-08 item H-01 / WP-01 K-02).
 *
