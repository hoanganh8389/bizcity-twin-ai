 ...
 *
 * Canonical owner: core/skills/includes/class-skill-rest-api.php (loaded by core/skills/bootstrap.php:50)
 *
 * Duplicate declaration of BizCity_Skill_REST_API that core/knowledge never required; the canonical copy is five times larger and is the one serving bizcity/skill/v1 (CORE-REDUCTION-WP-01 K-07).
 *
