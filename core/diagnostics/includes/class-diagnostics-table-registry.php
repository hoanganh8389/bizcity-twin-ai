...
final class BizCity_Diagnostics_Table_Registry {
	...
	private static function seed(): array {
		return [
			...
			// ── modules/webchat ────────────────────────────────────────────
			[ 'name' => 'bizcity_webchat_projects',      'owner' => 'modules/webchat', 'group' => 'webchat', 'class' => 'BizCity_WebChat_Database', 'lifecycle' => 'observe_active', 'quarantine_only' => true, 'orphan_gate' => 'Cut over TwinWeb/Intent project CRUD and prove owner-scoped replacement before DROP.' ],
			...
			[ 'name' => 'bizcity_webchat_tasks',         'owner' => 'modules/webchat', 'group' => 'webchat', 'class' => 'BizCity_WebChat_Database', 'lifecycle' => 'quarantine_write_block', 'quarantine_only' => true, 'orphan_gate' => 'Prove Goal/Event Stream task replacement and zero active task readers before DROP.' ],
			// [2026-07-29 Johnny Chu] PHASE-1.21-B — registry suffix matches class-webchat-database.php.
			[ 'name' => 'bizcity_webchat_task_steps',    'owner' => 'modules/webchat', 'group' => 'webchat', 'class' => 'BizCity_WebChat_Database', 'lifecycle' => 'quarantine_write_block', 'quarantine_only' => true, 'orphan_gate' => 'Prove task-step timeline replacement and zero active readers before DROP.' ],
			[ 'name' => 'bizcity_memory_session',        'owner' => 'modules/webchat', 'group' => 'webchat', 'class' => 'BizCity_WebChat_Database', 'lifecycle' => 'quarantine_write_block', 'quarantine_only' => true, 'orphan_gate' => 'Prove unified memory/event parity and zero legacy memory writers before DROP.' ],
