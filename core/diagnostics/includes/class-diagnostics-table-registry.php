...
final class BizCity_Diagnostics_Table_Registry {
	...
	private static function seed(): array {
		return [
			...
			// ── core/kg-hub ─────────────────────────────────────
			[ 'name' => 'bizcity_kg_notebooks',          'owner' => 'core/kg-hub',  'group' => 'knowledge', 'critical' => true, 'class' => 'BizCity_KG_Database' ],
			[ 'name' => 'bizcity_kg_notebook_sources',   'owner' => 'core/kg-hub',  'group' => 'knowledge', 'critical' => true, 'class' => 'BizCity_KG_Database' ],
			[ 'name' => 'bizcity_kg_passages',           'owner' => 'core/kg-hub',  'group' => 'knowledge', 'critical' => true, 'class' => 'BizCity_KG_Database' ],
			[ 'name' => 'bizcity_kg_entities',           'owner' => 'core/kg-hub',  'group' => 'knowledge', 'critical' => true, 'class' => 'BizCity_KG_Database' ],
			[ 'name' => 'bizcity_kg_relations',          'owner' => 'core/kg-hub',  'group' => 'knowledge', 'critical' => true, 'class' => 'BizCity_KG_Database' ],
			[ 'name' => 'bizcity_kg_passage_entities',   'owner' => 'core/kg-hub',  'group' => 'knowledge', 'critical' => true, 'class' => 'BizCity_KG_Database' ],
			[ 'name' => 'bizcity_kg_passage_relations',  'owner' => 'core/kg-hub',  'group' => 'knowledge', 'critical' => true, 'class' => 'BizCity_KG_Database' ],
			[ 'name' => 'bizcity_kg_triplet_queue',      'owner' => 'core/kg-hub',  'group' => 'knowledge', 'critical' => true, 'class' => 'BizCity_KG_Database' ],
			[ 'name' => 'bizcity_kg_provenance',         'owner' => 'core/kg-hub',  'group' => 'knowledge', 'class' => 'BizCity_KG_Database', 'feature' => 'source provenance', 'purpose' => 'Links KG rows back to their originating CMS/Studio record for citation trace.', 'readers' => [ 'BizCity_KG_Source_Adapter_Studio' ], 'writers' => [ 'BizCity_KG_Source_Adapter_Studio' ] ],
			[ 'name' => 'bizcity_kg_scope_links',        'owner' => 'core/kg-hub',  'group' => 'knowledge', 'class' => 'BizCity_KG_Database', 'feature' => 'scope binding', 'purpose' => 'Maps a scope (notebook/character) to a shared passage without duplicating rows.', 'readers' => [ 'BizCity_KG_Facade' ], 'writers' => [ 'BizCity_KG_Facade' ] ],
			[ 'name' => 'bizcity_kg_sources',            'owner' => 'core/kg-hub',  'group' => 'knowledge', 'critical' => true, 'class' => 'BizCity_KG_Database' ],
			[ 'name' => 'bizcity_kg_xref',               'owner' => 'core/kg-hub',  'group' => 'knowledge', 'class' => 'BizCity_KG_Database' ],
			[ 'name' => 'bizcity_kg_passage_identities', 'owner' => 'core/kg-hub',  'group' => 'knowledge', 'class' => 'BizCity_KG_Database' ],
			// [2026-08-21 Johnny Chu] KG-GURU-SCHEMA-INVENTORY — canonical notebook↔Guru attachment map used by attach_guru()/virtual merge.
			[ 'name' => 'bizcity_notebook_character_attachments', 'owner' => 'core/kg-hub', 'group' => 'knowledge', 'critical' => true, 'class' => 'BizCity_KG_Database' ],
			[ 'name' => 'bizcity_kg_workspaces',            'owner' => 'core/kg-hub', 'group' => 'knowledge', 'critical' => true, 'class' => 'BizCity_KG_Database' ],
			[ 'name' => 'bizcity_kg_grants',               'owner' => 'core/kg-hub', 'group' => 'knowledge', 'critical' => true, 'class' => 'BizCity_KG_Database' ],
			[ 'name' => 'bizcity_kg_acl_log',              'owner' => 'core/kg-hub', 'group' => 'knowledge', 'critical' => false, 'class' => 'BizCity_KG_Database' ],
			...
			// ── core/conversation (was modules/webchat; WP-11 C0b — DDL owner moved, table names unchanged) ──
			[ 'name' => 'bizcity_webchat_projects',      'owner' => 'core/conversation', 'group' => 'webchat', 'class' => 'BizCity_WebChat_Database', 'lifecycle' => 'retired', 'sql_status' => 'dead', 'replacement_status' => 'active', 'orphan_gate' => 'Verify TwinWeb/Intent notebook repository parity and COUNT(*)=0 before DROP.' ],
			...
			[ 'name' => 'bizcity_webchat_sessions',      'owner' => 'core/conversation', 'group' => 'webchat', 'class' => 'BizCity_WebChat_Database', 'lifecycle' => 'quarantine', 'sql_status' => 'active', 'replacement_status' => 'planned', 'orphan_gate' => 'Migrate session state to modules.webchat.session_state filestore, prove parity/zero-growth/zero-row and obtain owner approval before DROP.' ],
			...
			[ 'name' => 'bizcity_webchat_conversations', 'owner' => 'core/conversation', 'group' => 'webchat', 'class' => 'BizCity_WebChat_Database', 'lifecycle' => 'quarantine', 'sql_status' => 'active', 'replacement_status' => 'verified', 'orphan_gate' => 'Retain rows until zero-growth, zero-row, approval and G5 gates; no production DROP.' ],
			...
			[ 'name' => 'bizcity_webchat_tasks',         'owner' => 'core/conversation', 'group' => 'webchat', 'class' => 'BizCity_WebChat_Database', 'lifecycle' => 'retired', 'sql_status' => 'dead', 'replacement_status' => 'active', 'orphan_gate' => 'Verify Goal/Event Stream task replacement and COUNT(*)=0 before DROP.' ],
			// [2026-07-29 Johnny Chu] PHASE-1.21-B — registry suffix matches class-webchat-database.php.
			[ 'name' => 'bizcity_webchat_task_steps',    'owner' => 'core/conversation', 'group' => 'webchat', 'class' => 'BizCity_WebChat_Database', 'lifecycle' => 'retired', 'sql_status' => 'dead', 'replacement_status' => 'active', 'orphan_gate' => 'Verify Event Stream task-step timeline replacement and COUNT(*)=0 before DROP.' ],
			[ 'name' => 'bizcity_memory_session',        'owner' => 'core/conversation', 'group' => 'webchat', 'class' => 'BizCity_WebChat_Database', 'lifecycle' => 'retired', 'sql_status' => 'dead', 'replacement_status' => 'active', 'orphan_gate' => 'Verify Context Bank memory reference and COUNT(*)=0 before DROP.' ],
	...
	public static function deprecated_tables(): array {
		$seed = [
			...
			[ 'name' => 'bizcity_kg_mentions',           'module' => 'core/kg-hub', 'feature' => 'knowledge graph', 'purpose' => 'Legacy passage/entity graph edges', 'class' => 'BizCity_KG_Database', 'reason' => 'DEAD SQL TABLE — no active INSERT/SELECT consumer; no automatic replacement or backfill.', 'sql_status' => 'dead', 'replacement_status' => 'none', 'orphan_gate' => 'Confirm no active owner and COUNT(*)=0 before DROP.' ],
