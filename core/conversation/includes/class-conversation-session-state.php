 ...
 *
 * [2026-09-24 Claude Opus 5.5] CORE-REDUCTION WP-11 C0a — moved here from
 * modules/webchat/includes/class-webchat-session-state.php together with the conversation store
 * (its V3 session methods delegate to this class). Class name and file-contract ids unchanged.
 *
