 ...
 *
 * [2026-09-25 Claude Sonnet 5] CORE-REDUCTION — moved from core/diagnostics/includes/ to core/helper/includes/.
 * Five runtime REST classes `use` this trait (TwinBrain x3, Research, TwinChat sources); core/diagnostics is a private
 * package that is not published, so the trait must live in a shipped core. core/diagnostics/includes/trait-rest-error.php
 * is now a shim that loads this file.
 */
