 ...
 *
 * Canonical owner: none — the feature was never wired
 *
 * Declares BizCity_Knowledge_Provider_Registry and BizCity_Knowledge_Router_Pipeline, neither of which is referenced anywhere in the plugin, and registers a hook (bizcity_knowledge_router_register) that nothing fires. The file was required by core/intent/bootstrap.php:89 and parsed on every intent request without ever being used (CORE-REDUCTION-WP-02 I-04).
 *
