...
| Field | Value |
|-------|-------|
| Timestamp | 2026-04-02 14:26:47 UTC |
| Trace ID | trace_2ba3eab8e5443b0d |
| Site ID | 583 |
| User ID | 6 |
...
<details>
<summary>Click to expand full prompt (8171 chars)</summary>
...
LỊCH SỬ HỘI THOẠI GẦN ĐÂY (để hiểu ngữ cảnh tin nhắn hiện tại):
  ...
  • Chủ nhân: được tạo từ đâu?
  • AI: BizGPT được phát triển dựa trên công nghệ GPT (Generative Pre-trained Transformer) của OpenAI. Nó kết hợp khả năng xử lý ngôn ngữ tự nhiên với các ứng

Tin nhắn: "bizgpt tạo từ đâu?"
...
```json
{
    ...
    "meta": {
        "llm_tokens": {
            ...
            "total_tokens": 2826,
            "cost": 0.00108979999999999992675581150791686013690195977687835693359375,
            "is_byok": false,
            ...
            "cost_details": {
                "upstream_inference_cost": 0.00108979999999999992675581150791686013690195977687835693359375,
                "upstream_inference_prompt_cost": 0.000814799999999999964399310936613574085640721023082733154296875,
