...
| Field | Value |
|-------|-------|
| Timestamp | 2026-04-02 12:44:20 UTC |
| Trace ID | trace_eaa55097a8be921c |
| Site ID | 583 |
| User ID | 6 |
...
<details>
<summary>Click to expand full prompt (7979 chars)</summary>
...
LỊCH SỬ HỘI THOẠI GẦN ĐÂY (để hiểu ngữ cảnh tin nhắn hiện tại):
  • Chủ nhân: có biết bizgpt ko?
  • AI: BizGPT là một nền tảng AI được thiết kế để hỗ trợ doanh nghiệp trong việc tối ưu hóa quy trình làm việc, tạo nội dung và phân tích dữ liệu. Nó sử dụng

Tin nhắn: "được tạo từ đâu?"
...
```json
{
    ...
    "meta": {
        "llm_tokens": {
            ...
            "total_tokens": 2775,
            "cost": 0.001074499999999999934330308093421990633942186832427978515625,
            "is_byok": false,
            ...
            "cost_details": {
                "upstream_inference_cost": 0.001074499999999999934330308093421990633942186832427978515625,
                "upstream_inference_prompt_cost": 0.000799499999999999971973807522118704582680948078632354736328125,
                "upstream_inference_completions_cost": 0.0002750000000000000165666091955785077516338787972927093505859375
            },
