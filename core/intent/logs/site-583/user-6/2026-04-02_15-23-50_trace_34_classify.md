...
| Field | Value |
|-------|-------|
| Timestamp | 2026-04-02 15:23:53 UTC |
| Trace ID | trace_34e26add810de2fc |
| Site ID | 583 |
| User ID | 6 |
...
<details>
<summary>Click to expand full prompt (8127 chars)</summary>
...
LỊCH SỬ HỘI THOẠI GẦN ĐÂY (để hiểu ngữ cảnh tin nhắn hiện tại):
  ...
  • AI: BizGPT được tạo ra bởi Bizcity. Nếu bạn cần thêm thông tin về BizGPT hoặc các tính năng của nó, hãy cho tôi biết!
  • Chủ nhân: Truyền là thằng nào
  • AI: Lê Đình Truyền là một người dạy về AI và được biết đến với bộ Twin AI đỉnh cấp. Nếu bạn cần thêm thông tin cụ thể về ông ấy, hãy cho tôi biết!

Tin nhắn: "ok, who is Truyền"
...
```json
{
    ...
    "meta": {
        "llm_tokens": {
            ...
            "total_tokens": 2823,
            "cost": 0.001097700000000000064570571112199104391038417816162109375,
            "is_byok": false,
            ...
            "cost_details": {
                "upstream_inference_cost": 0.001097700000000000064570571112199104391038417816162109375,
                "upstream_inference_prompt_cost": 0.0008126999999999999675648343355760516715236008167266845703125,
