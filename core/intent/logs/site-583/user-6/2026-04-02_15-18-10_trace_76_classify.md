...
| Field | Value |
|-------|-------|
| Timestamp | 2026-04-02 15:18:13 UTC |
| Trace ID | trace_76d423f190c41675 |
| Site ID | 583 |
| User ID | 6 |
...
<details>
<summary>Click to expand full prompt (8172 chars)</summary>
...
LỊCH SỬ HỘI THOẠI GẦN ĐÂY (để hiểu ngữ cảnh tin nhắn hiện tại):
  • Chủ nhân: bizgpt tạo từ đâu?
  • AI: BizGPT được phát triển bởi một nhóm nghiên cứu và phát triển công nghệ AI, không phải từ một nguồn cụ thể nào khác. Nó dựa trên nền tảng công nghệ của
  • Chủ nhân: bizgpt tạo từ đâu?
  • AI: BizGPT là một sản phẩm được phát triển bởi một nhóm hoặc công ty cụ thể, nhưng thông tin chi tiết về nguồn gốc chính xác của nó có thể không rõ ràng. 
...
```json
{
    ...
    "meta": {
        "llm_tokens": {
            ...
            "total_tokens": 2829,
            "cost": 0.00109949999999999999990285548534529880271293222904205322265625,
            "is_byok": false,
            ...
            "cost_details": {
                "upstream_inference_cost": 0.00109949999999999999990285548534529880271293222904205322265625,
                "upstream_inference_prompt_cost": 0.000814500000000000011317335957272689483943395316600799560546875,
