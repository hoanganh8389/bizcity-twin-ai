...
| Field | Value |
|-------|-------|
| Timestamp | 2026-04-03 00:35:28 UTC |
| Trace ID | trace_e3dd67d24ba0b395 |
| Site ID | 1258 |
| User ID | 5 |
...
<details>
<summary>Click to expand full prompt (8749 chars)</summary>
...
🟢 Gõ **OK** để thực hiện, hoặc bổ sung/chỉnh sửa thêm.
  • Chủ nhân: ok
  • AI: ✅ Đã đăng bài: **AI Agentic: Chìa khóa để bứt phá năng suất, bạn đã sẵn sàng?**
🔗 https://bizcity.vn/2026/04/03/ai-agentic-chia-khoa-de-but-pha-nang-s
...
```json
{
    ...
    "meta": {
        "llm_tokens": {
            ...
            "total_tokens": 3098,
            "cost": 0.001188999999999999952760010302199589204974472522735595703125,
            "is_byok": false,
            ...
            "cost_details": {
                "upstream_inference_cost": 0.001188999999999999952760010302199589204974472522735595703125,
                "upstream_inference_prompt_cost": 0.00089400000000000004636568906590810001944191753864288330078125,
