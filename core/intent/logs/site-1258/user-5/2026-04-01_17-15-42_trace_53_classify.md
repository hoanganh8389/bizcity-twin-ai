...
| Field | Value |
|-------|-------|
| Timestamp | 2026-04-01 17:15:46 UTC |
| Trace ID | trace_53e4f3e38b274657 |
| Site ID | 1258 |
| User ID | 5 |
...
```
AI agent và cuộc cách mạng công nghệ
```
...
<details>
<summary>Click to expand full prompt (8348 chars)</summary>
...
Tin nhắn: "AI agent và cuộc cách mạng công nghệ"
...
```json
{
    ...
    "meta": {
        "llm_tokens": {
            ...
            "total_tokens": 2924,
            "cost": 0.00113900000000000003845535001545385966892354190349578857421875,
            "is_byok": false,
            ...
            "cost_details": {
                "upstream_inference_cost": 0.00113900000000000003845535001545385966892354190349578857421875,
                "upstream_inference_prompt_cost": 0.00084150000000000001708355679141959626576863229274749755859375,
                "upstream_inference_completions_cost": 0.000297500000000000021371793224034263403154909610748291015625
            },
