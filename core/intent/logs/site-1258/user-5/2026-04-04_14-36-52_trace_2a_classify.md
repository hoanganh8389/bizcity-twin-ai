...
| Field | Value |
|-------|-------|
| Timestamp | 2026-04-04 14:36:55 UTC |
| Trace ID | trace_2a259e8a5aeea278 |
| Site ID | 1258 |
| User ID | 5 |
...
```
tìm kiếm thêm thông tin về AI agent nhé
```
...
<details>
<summary>Click to expand full prompt (8046 chars)</summary>
...
Tin nhắn: "tìm kiếm thêm thông tin về AI agent nhé"
...
```json
{
    ...
    "meta": {
        "llm_tokens": {
            ...
            "total_tokens": 2805,
            "cost": 0.001092300000000000041733283495659634354524314403533935546875,
            "is_byok": false,
            ...
            "cost_details": {
                "upstream_inference_cost": 0.001092300000000000041733283495659634354524314403533935546875,
                "upstream_inference_prompt_cost": 0.000807300000000000053147763967587025035754777491092681884765625,
