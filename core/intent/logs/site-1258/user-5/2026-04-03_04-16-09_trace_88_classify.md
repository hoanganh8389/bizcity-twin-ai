...
| Field | Value |
|-------|-------|
| Timestamp | 2026-04-03 04:16:11 UTC |
| Trace ID | trace_880697ca011d8090 |
| Site ID | 1258 |
| User ID | 5 |
...
```
Plugin wordpress cũng có thể hoạt động như openclaw
```
...
Tin nhắn: "Plugin wordpress cũng có thể hoạt động như openclaw"
...
```json
{
    ...
    "meta": {
        "llm_tokens": {
            ...
            "total_tokens": 2940,
            "cost": 0.00113279999999999999617250612260477282688952982425689697265625,
            "is_byok": false,
            ...
            "cost_details": {
                "upstream_inference_cost": 0.00113279999999999999617250612260477282688952982425689697265625,
                "upstream_inference_prompt_cost": 0.000847800000000000007586986594532163508119992911815643310546875,
