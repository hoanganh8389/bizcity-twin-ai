...
| Field | Value |
|-------|-------|
| Timestamp | 2026-04-02 13:06:42 UTC |
| Trace ID | trace_62d1e9c2b9ff1247 |
| Site ID | 1258 |
| User ID | 5 |
...
<details>
<summary>Click to expand full prompt (8773 chars)</summary>
...
CONTEXT hiện tại:
- Goal đang active: followup:create_facebook_post (Tạo & đăng bài Facebook)
- Trạng thái: ACTIVE
- Đang chờ field: 

LỊCH SỬ HỘI THOẠI GẦN ĐÂY (để hiểu ngữ cảnh tin nhắn hiện tại):
  • Chủ nhân: Tuyền là ai
  • AI: Chào anh Johnny,

Tôi là trợ lý ảo của bizcity, được thiết kế để hỗ trợ anh trong các công việc và cung cấp thông tin. Tôi không biết Tuyền là ai cả.

USER MEMORY: [habit] yêu thỏ | [constraint] lập trình, dự án

Tin nhắn: "tạo và đăng bài facebook"
...
```json
{
    ...
    "meta": {
        "llm_tokens": {
            ...
            "total_tokens": 3090,
            "cost": 0.00123060000000000009656719868189611588604748249053955078125,
            "is_byok": false,
            ...
            "cost_details": {
                "upstream_inference_cost": 0.00123060000000000009656719868189611588604748249053955078125,
                "upstream_inference_prompt_cost": 0.000885599999999999950607565413207566962228156626224517822265625,
                "upstream_inference_completions_cost": 0.0003449999999999999833293073958628838227014057338237762451171875
            },
