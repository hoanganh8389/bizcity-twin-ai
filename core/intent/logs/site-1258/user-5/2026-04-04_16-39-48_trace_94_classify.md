...
| Field | Value |
|-------|-------|
| Timestamp | 2026-04-04 16:39:50 UTC |
| Trace ID | trace_9412ddbc5e192909 |
| Site ID | 1258 |
| User ID | 5 |
...
```
@order_stats Thống kê doanh thu, đơn hàng theo ngày/tuần/tháng
```
...
```json
{
    "regex": "\/báo cáo|thống kê|report|doanh thu|doanh số\/ui",
    "goal": "report",
...
10. report: Báo cáo thống kê | slots: report_type, date_range, metric
```

## 5. Full LLM Prompt

<details>
<summary>Click to expand full prompt (7935 chars)</summary>
...
Tin nhắn: "@order_stats Thống kê doanh thu, đơn hàng theo ngày/tuần/tháng"
...
```json
```json
{"mode":"knowledge","confidence":0.8,"is_memory":false,"memory_type":"","built_in_function":"","knowledge_type":"advisor","suggested_tool":"report","intent":"","goal":"","goal_label":"","entities":{},"filled_slots":[],"missing_slots":[]}
```
```
...
```json
{
    ...
    "meta": {
        "llm_tokens": {
            ...
            "total_tokens": 2728,
            "cost": 0.00096579999999999994846067163933867050218395888805389404296875,
            "is_byok": false,
            ...
            "cost_details": {
                "upstream_inference_cost": 0.00096579999999999994846067163933867050218395888805389404296875,
                "upstream_inference_prompt_cost": 0.00079830000000000005122569035620472277514636516571044921875,
                "upstream_inference_completions_cost": 0.000167500000000000005655198531684391127782873809337615966796875
            },
