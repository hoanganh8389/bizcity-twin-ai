...
| Field | Value |
|-------|-------|
| Timestamp | 2026-04-04 14:31:54 UTC |
| Trace ID | trace_cfae694e8cd1411d |
| Site ID | 1258 |
| User ID | 5 |
...
```
@bizcoach_consult xem chieem tinh ngày mai tôi thế nào
```
...
<details>
<summary>Click to expand full prompt (8427 chars)</summary>
...
LỊCH SỬ HỘI THOẠI GẦN ĐÂY (để hiểu ngữ cảnh tin nhắn hiện tại):
  • Chủ nhân: đăng bài viết lên wbe
  • AI: Bạn muốn đăng bài viết lên web với nội dung gì ạ? Vui lòng cung cấp cho mình chủ đề hoặc các ý chính bạn muốn truyền tải nhé.
  • Chủ nhân: mình muốn đăng bài lên web
  • AI: Tuyệt! Bạn muốn viết về chủ đề gì nè? Mô tả càng chi tiết thì bài viết càng hay 😊
USER MEMORY: [habit] yêu thỏ | [constraint] lập trình, dự án

Tin nhắn: "@bizcoach_consult xem chieem tinh ngày mai tôi thế nào"
...
```json
```json
{"mode":"execution","confidence":0.9,"is_memory":false,"memory_type":"","built_in_function":"","knowledge_type":"","suggested_tool":"","intent":"new_goal","goal":"bizcoach_consult","goal_label":"BizCoach Consult","entities":{"query":"chiêm tinh ngày mai tôi thế nào"},"filled_slots":["query"],"missing_slots":[]}
```
```
...
```json
{
    ...
    "entities": {
        "query": "chiêm tinh ngày mai tôi thế nào"
    },
    "filled_slots": [
        "query"
    ],
...
```json
{
    ...
    "meta": {
        "llm_tokens": {
            ...
            "total_tokens": 2902,
            "cost": 0.0010620000000000000099642516460107799503020942211151123046875,
            "is_byok": false,
            ...
            "cost_details": {
                "upstream_inference_cost": 0.0010620000000000000099642516460107799503020942211151123046875,
                "upstream_inference_prompt_cost": 0.00084449999999999998158417557903021588572300970554351806640625,
                "upstream_inference_completions_cost": 0.00021750000000000000127502175484295321439276449382305145263671875
            },
