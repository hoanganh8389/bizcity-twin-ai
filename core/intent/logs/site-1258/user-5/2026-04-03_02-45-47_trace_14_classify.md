...
| Field | Value |
|-------|-------|
| Timestamp | 2026-04-03 02:45:49 UTC |
| Trace ID | trace_14fac33c41931d9e |
| Site ID | 1258 |
| User ID | 5 |
...
1. post_facebook: Đăng bài Facebook | tùy chọn: message(text), image_url(url), content(text), title(text), url(url)
2. post_facebook: Đăng bài Facebook | cần: message(text), image_url(url), content(text), title(text), url(url)
...
<details>
<summary>Click to expand full prompt (7919 chars)</summary>
...
Tin nhắn: "Viết bài blog + Đăng Facebook"
...
```json
{
    ...
    "meta": {
        "llm_tokens": {
            ...
            "total_tokens": 2775,
            "cost": 0.0010920999999999999284516771780317867523990571498870849609375,
            "is_byok": false,
            ...
            "cost_details": {
                "upstream_inference_cost": 0.0010920999999999999284516771780317867523990571498870849609375,
                "upstream_inference_prompt_cost": 0.00079710000000000002205735594174029756686650216579437255859375,
