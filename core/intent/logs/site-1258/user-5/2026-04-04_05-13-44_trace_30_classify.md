...
| Field | Value |
|-------|-------|
| Timestamp | 2026-04-04 05:13:47 UTC |
| Trace ID | trace_3014278ee6d0267e |
| Site ID | 1258 |
| User ID | 5 |
...
<details>
<summary>Click to expand full prompt (8020 chars)</summary>
...
```json
```json
{"mode":"ambiguous","confidence":1.0,"is_memory":false,"memory_type":"","built_in_function":"","knowledge_type":"","suggested_tool":"","intent":"","goal":"","goal_label":"","entities":{},"filled_slots":[],"missing_slots":[]}
```
```
    ...
    "meta": {
        "llm_tokens": {
            ...
            "cost_details": {
                ...
                "upstream_inference_prompt_cost": 0.00080579999999999996247723732523127182503230869770050048828125,
                "upstream_inference_completions_cost": 0.00016000000000000001308848862624500952733797021210193634033203125
            },
