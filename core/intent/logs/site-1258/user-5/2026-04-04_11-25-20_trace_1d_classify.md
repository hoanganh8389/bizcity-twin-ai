...
| Field | Value |
|-------|-------|
| Timestamp | 2026-04-04 11:25:22 UTC |
| Trace ID | trace_1d639bcac3b432af |
| Site ID | 1258 |
| User ID | 5 |
...
<details>
<summary>Click to expand full prompt (8373 chars)</summary>
...
Tin nhắn: "mình muốn đăng bài lên web"
...
```json
```json
{"mode":"execution","confidence":0.85,"is_memory":false,"memory_type":"","built_in_function":"","knowledge_type":"","suggested_tool":"","intent":"continue_goal","goal":"write_article","goal_label":"Viết bài","entities":{},"filled_slots":[],"missing_slots":["topic"]}
```
```
...
```json
{
    ...
    "meta": {
        "llm_tokens": {
            ...
            "total_tokens": 2909,
            "cost": 0.00104210000000000001414701689128605721634812653064727783203125,
            "is_byok": false,
            ...
            "cost_details": {
                "upstream_inference_cost": 0.00104210000000000001414701689128605721634812653064727783203125,
                "upstream_inference_prompt_cost": 0.00084960000000000005133948821622880132053978741168975830078125,
                "upstream_inference_completions_cost": 0.00019249999999999998991258298719486674599465914070606231689453125
            },
