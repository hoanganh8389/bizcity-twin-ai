...
| Field | Value |
|-------|-------|
| Timestamp | 2026-03-31 06:23:55 UTC |
| Trace ID | trace_a1d2f0bbc541b8d8 |
| Site ID | 1258 |
| User ID | 5 |
...
<details>
<summary>Click to expand full prompt (8514 chars)</summary>
...
CONTEXT hiện tại:
- Goal đang active: followup:bizcoach_consult (Tư vấn chiêm tinh)
- Trạng thái: ACTIVE
- Đang chờ field: 
...
```json
{
    ...
    "meta": {
        "llm_tokens": {
            ...
            "total_tokens": 2987,
            "cost": 0.0012371000000000000919320175540860873297788202762603759765625,
            "is_byok": false,
            ...
            "cost_details": {
                "upstream_inference_cost": 0.0012371000000000000919320175540860873297788202762603759765625,
                "upstream_inference_prompt_cost": 0.00084960000000000005133948821622880132053978741168975830078125,
