...
| Field | Value |
|-------|-------|
| Timestamp | 2026-04-03 04:32:27 UTC |
| Trace ID | trace_e29237482ccf1bdd |
| Site ID | 1258 |
| User ID | 5 |
...
```
Gửi email cho support@example.com tiêu đề Xin chào
```
...
```json
{
    "regex": "\/gửi mail|gửi email|send mail|send email|soạn mail|soạn email|compose mail\/ui",
...
1. gmail_send_message: Gửi email Gmail — Soạn và gửi email qua Gmail | cần: to(text), subject(text), body(text)
2. gmail_send_message: Gửi email Gmail — Soạn và gửi email qua Gmail | cần: to(text), subject(text), body(text)
...
<details>
<summary>Click to expand full prompt (8446 chars)</summary>
...
LỊCH SỬ HỘI THOẠI GẦN ĐÂY (để hiểu ngữ cảnh tin nhắn hiện tại):
  • Chủ nhân: đăng bài lên web rồi sau đó đăng lên facebook
  • AI: 📋 Mình hiểu bạn muốn thực hiện 2 bước chính:

🔧 Viết bài blog
🔧 Đăng Facebook

❓ **Nội dung cụ thể là gì?** Bạn mô tả càng chi tiết càng tốt — ví dụ: 
  • Chủ nhân: Plugin wordpress cũng có thể hoạt động như openclaw
  • AI: 📋 Kế hoạch thực hiện (2 bước):
1. 🔧 Viết bài blog
2. 🔧 Đăng Facebook

[👁 Xem & Chạy Workflow #48](https://bizcity.vn/wp-admin/admin.php?page=bizcity-w
USER MEMORY: [habit] yêu thỏ | [constraint] lập trình, dự án

Tin nhắn: "Gửi email cho support@example.com tiêu đề Xin chào"
...
```json
{
    ...
    "meta": {
        "llm_tokens": {
            ...
            "total_tokens": 3015,
            "cost": 0.0012829000000000000125677246387567720375955104827880859375,
            "is_byok": false,
            ...
            "cost_details": {
                "upstream_inference_cost": 0.0012829000000000000125677246387567720375955104827880859375,
                "upstream_inference_prompt_cost": 0.00085289999999999996892208198318030554219149053096771240234375,
                "upstream_inference_completions_cost": 0.0004299999999999999894355340313012447950313799083232879638671875
            },
