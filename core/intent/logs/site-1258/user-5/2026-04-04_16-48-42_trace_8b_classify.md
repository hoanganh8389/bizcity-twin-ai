...
| Field | Value |
|-------|-------|
| Timestamp | 2026-04-04 16:48:44 UTC |
| Trace ID | trace_8b2cecd6300a532b |
| Site ID | 1258 |
| User ID | 5 |
...
<details>
<summary>Click to expand full prompt (8428 chars)</summary>
...
LỊCH SỬ HỘI THOẠI GẦN ĐÂY (để hiểu ngữ cảnh tin nhắn hiện tại):
  • Chủ nhân: @order_stats Thống kê doanh thu, đơn hàng theo ngày/tuần/tháng
  • AI: Chào Johnny,

Bạn muốn thống kê doanh thu và đơn hàng theo ngày/tuần/tháng đúng không? Để mình giúp bạn nhé.

Bạn có thể cho mình biết bạn muốn thống 
...
```json
{
    ...
    "meta": {
        "llm_tokens": {
            ...
            "total_tokens": 2951,
            "cost": 0.001144899999999999910815784431861175107769668102264404296875,
            "is_byok": false,
            ...
            "cost_details": {
                "upstream_inference_cost": 0.001144899999999999910815784431861175107769668102264404296875,
                "upstream_inference_prompt_cost": 0.00084990000000000000442146319556968592223711311817169189453125,
