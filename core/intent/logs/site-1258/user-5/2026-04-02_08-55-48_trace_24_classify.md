...
| Field | Value |
|-------|-------|
| Timestamp | 2026-04-02 08:55:53 UTC |
| Trace ID | trace_24d7dfff660e5f86 |
| Site ID | 1258 |
| User ID | 5 |
...
```
viết bài về kiến trúc ai agent
```
...
<details>
<summary>Click to expand full prompt (8274 chars)</summary>
...
Tin nhắn: "viết bài về kiến trúc ai agent"
...
```json
{
    ...
    "meta": {
        "llm_tokens": {
            ...
            "total_tokens": 2939,
            "cost": 0.00120509999999999996463106999300407551345415413379669189453125,
            "is_byok": false,
            ...
            "cost_details": {
                "upstream_inference_cost": 0.00120509999999999996463106999300407551345415413379669189453125,
                "upstream_inference_prompt_cost": 0.000837599999999999976496578568685436039231717586517333984375,
                "upstream_inference_completions_cost": 0.00036749999999999998813449142431863947422243654727935791015625
            },
