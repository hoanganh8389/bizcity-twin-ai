...
| Field | Value |
|-------|-------|
| Timestamp | 2026-04-03 03:04:00 UTC |
| Trace ID | trace_c5da3ca5f41fdc08 |
| Site ID | 1258 |
| User ID | 5 |
...
```
đăng bài lên web rồi sau đó đăng lên facebook
```
...
<details>
<summary>Click to expand full prompt (7839 chars)</summary>
...
Tin nhắn: "đăng bài lên web rồi sau đó đăng lên facebook"
...
```json
```json
{"mode":"knowledge","confidence":0.7,"is_memory":false,"memory_type":"","built_in_function":"","knowledge_type":"advisor","suggested_tool":"write_article","intent":"","goal":"","goal_label":"","entities":{},"filled_slots":[],"missing_slots":[]}
```
```
...
```json
{
    ...
    "meta": {
        "llm_tokens": {
            ...
            "total_tokens": 2707,
            "cost": 0.00096389999999999995648758410737855228944681584835052490234375,
            "is_byok": false,
            ...
            "cost_details": {
                "upstream_inference_cost": 0.00096389999999999995648758410737855228944681584835052490234375,
                "upstream_inference_prompt_cost": 0.00079140000000000004613809334585994292865507304668426513671875,
