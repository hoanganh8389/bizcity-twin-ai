...
| Field | Value |
|-------|-------|
| Timestamp | 2026-03-31 16:00:12 UTC |
| Trace ID | trace_c2cf78f026c96950 |
| Site ID | 1258 |
| User ID | 5 |
...
<details>
<summary>Click to expand full prompt (8398 chars)</summary>
...
Tin nhắn: "Cuộc cách mạng về AI agentic"
...
```json
{
    ...
    "meta": {
        "llm_tokens": {
            ...
            "total_tokens": 2938,
            "cost": 0.0011410000000000000870692407062279016827233135700225830078125,
            "is_byok": false,
            ...
            "cost_details": {
                "upstream_inference_cost": 0.0011410000000000000870692407062279016827233135700225830078125,
