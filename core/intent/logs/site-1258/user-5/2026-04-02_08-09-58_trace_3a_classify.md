...
| Field | Value |
|-------|-------|
| Timestamp | 2026-04-02 08:10:04 UTC |
| Trace ID | trace_3aed1da3ecffbae8 |
| Site ID | 1258 |
| User ID | 5 |
...
```
tao cần mày đăng bài lên web, nhưng sau đó đăng thêm cho tao facebook
```
...
<details>
<summary>Click to expand full prompt (8313 chars)</summary>
...
Tin nhắn: "tao cần mày đăng bài lên web, nhưng sau đó đăng thêm cho tao facebook"
...
```json
{
    ...
    "meta": {
        "llm_tokens": {
            ...
            "total_tokens": 2918,
            "cost": 0.00113499999999999994122756863390577564132399857044219970703125,
            "is_byok": false,
            ...
            "cost_details": {
                "upstream_inference_cost": 0.00113499999999999994122756863390577564132399857044219970703125,
                "upstream_inference_prompt_cost": 0.0008400000000000000348332473976142864557914435863494873046875,
