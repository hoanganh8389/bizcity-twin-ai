...
| Field | Value |
|-------|-------|
| Timestamp | 2026-04-02 07:11:51 UTC |
| Trace ID | trace_e363fa462b2d5ae1 |
| Site ID | 1258 |
| User ID | 5 |
...
```json
{
    "goal": "followup:scheduler_create_event",
...
<details>
<summary>Click to expand full prompt (8345 chars)</summary>
...
CONTEXT hiện tại:
- Goal đang active: followup:scheduler_create_event (Tao su kien lich)
- Trạng thái: ACTIVE
- Đang chờ field: 

Tin nhắn: "đúng rồi, làm đi"
...
```json
```json
{"mode":"execution","confidence":0.8,"is_memory":false,"memory_type":"","built_in_function":"","knowledge_type":"","suggested_tool":"","intent":"continue_goal","goal":"scheduler_create_event","goal_label":"Tao su kien lich","entities":{},"filled_slots":[],"missing_slots":[]}
```
```
...
```json
{
    ...
    "meta": {
        "llm_tokens": {
            ...
            "total_tokens": 2886,
            "cost": 0.00103959999999999989916954490354328299872577190399169921875,
            "is_byok": false,
            ...
            "cost_details": {
                "upstream_inference_cost": 0.00103959999999999989916954490354328299872577190399169921875,
                "upstream_inference_prompt_cost": 0.000842100000000000031667723998651808869908563792705535888671875,
                "upstream_inference_completions_cost": 0.00019750000000000000302709246557952837974880822002887725830078125
            },
