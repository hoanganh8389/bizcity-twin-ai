...
| Field | Value |
|-------|-------|
| Timestamp | 2026-04-02 08:08:02 UTC |
| Trace ID | trace_d52dfb6ad86899bc |
| Site ID | 1258 |
| User ID | 5 |
...
```json
{
    "regex": "\/chiêm tinh|tử vi|bói (?:toán|bài|quẻ)|hoa tinh|natal|transit|phong thủy|vận mệnh|vận hạn|bản đồ sao|sao hôm nay|dự báo vận|xem vận|cung hoàng đạo|thần số học|tarot|horoscope|lá số\/ui",
...
★ 1. bizcoach_consult: Tư vấn chiêm tinh — User hỏi liên quan đến chiêm tinh, tử vi, vận mệnh, bản đồ sao, phong thủy, taro | cần: user_id(number), prompt(text) | tùy chọn: prompt_images(image)
...
<details>
<summary>Click to expand full prompt (8363 chars)</summary>
...
```json
{
    ...
    "meta": {
        "llm_tokens": {
            ...
            "total_tokens": 2967,
            "cost": 0.00067011000000000001987354725230261465185321867465972900390625,
            "is_byok": false,
            ...
            "cost_details": {
                "upstream_inference_cost": 0.00067011000000000001987354725230261465185321867465972900390625,
                "upstream_inference_prompt_cost": 0.000295110000000000012067291610406982726999558508396148681640625,
