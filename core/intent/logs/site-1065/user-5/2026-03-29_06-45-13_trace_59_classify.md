...
| Field | Value |
|-------|-------|
| Timestamp | 2026-03-29 06:45:15 UTC |
| Trace ID | trace_595f0380241dcb7d |
| Site ID | 1065 |
| User ID | 5 |
...
```
xem công việc tài chính tuần tới của tôi ok ko
```
...
<details>
<summary>Click to expand full prompt (7411 chars)</summary>
...
Tin nhắn: "xem công việc tài chính tuần tới của tôi ok ko"
...
```json
{
  ...
  "entities": {
    "prompt": "công việc tài chính tuần tới của tôi ok ko"
  },
  "filled_slots": [
    "prompt"
  ],
...
```json
{
    ...
    "meta": {
        "llm_tokens": {
            ...
            "total_tokens": 2647,
            "cost": 0.00113950000000000010481893131242259187274612486362457275390625,
            "is_byok": false,
            ...
            "cost_details": {
                "upstream_inference_cost": 0.00113950000000000010481893131242259187274612486362457275390625,
                "upstream_inference_prompt_cost": 0.00074700000000000005111189249618064422975294291973114013671875,
                "upstream_inference_completions_cost": 0.0003924999999999999994969301919667259426205419003963470458984375
            },
