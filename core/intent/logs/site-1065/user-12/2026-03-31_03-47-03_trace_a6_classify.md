...
| Field | Value |
|-------|-------|
| Timestamp | 2026-03-31 03:47:05 UTC |
| Trace ID | trace_a66170de6c8695e9 |
| Site ID | 1065 |
| User ID | 12 |
...
```
trưa nay tôi được ăn bao nhiêu cơm
```
...
<details>
<summary>Click to expand full prompt (7296 chars)</summary>
...
Tin nhắn: "trưa nay tôi được ăn bao nhiêu cơm"
...
```json
{
  ...
  "entities": {
    "prompt": "trưa nay tôi được ăn bao nhiêu cơm"
  },
  "filled_slots": [
    "prompt"
  ],
...
```json
{
    ...
    "meta": {
        "llm_tokens": {
            ...
            "total_tokens": 2606,
            "cost": 0.00112499999999999991499854967713645237381570041179656982421875,
            "is_byok": false,
            ...
            "cost_details": {
                "upstream_inference_cost": 0.00112499999999999991499854967713645237381570041179656982421875,
                "upstream_inference_prompt_cost": 0.0007349999999999999762689828486372789484448730945587158203125,
                "upstream_inference_completions_cost": 0.0003899999999999999929396754527743951257434673607349395751953125
            },
