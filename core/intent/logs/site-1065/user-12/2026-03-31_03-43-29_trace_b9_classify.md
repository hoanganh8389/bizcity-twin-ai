...
| Field | Value |
|-------|-------|
| Timestamp | 2026-03-31 03:43:31 UTC |
| Trace ID | trace_b9403b20bb7ab3b8 |
| Site ID | 1065 |
| User ID | 12 |
...
```
sáng nay tôi ăn 1 quả chuối tiêu rồi, là bao nhiêu kcal? tôi còn được ăn bao nhiêu kcal nữa
```
...
<details>
<summary>Click to expand full prompt (7353 chars)</summary>
...
Tin nhắn: "sáng nay tôi ăn 1 quả chuối tiêu rồi, là bao nhiêu kcal? tôi còn được ăn bao nhiêu kcal nữa"
...
```json
{
    ...
    "meta": {
        "llm_tokens": {
            ...
            "total_tokens": 2587,
            "cost": 0.0010400999999999999655331262005120152025483548641204833984375,
            "is_byok": false,
            ...
            "cost_details": {
                "upstream_inference_cost": 0.0010400999999999999655331262005120152025483548641204833984375,
                "upstream_inference_prompt_cost": 0.0007401000000000000460242954858358643832616508007049560546875,
                "upstream_inference_completions_cost": 0.0002999999999999999737189393389513725196593441069126129150390625
            },
