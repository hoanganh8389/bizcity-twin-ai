...
class BizCity_KG_Skeleton_Assets {
	...
	public static function register(): void {
		...
		// [2026-09-24 Claude Opus 5.5] CORE-REDUCTION WP-11 A — KG-Hub moved to core/kg-hub/; prefer its own URL constant.
		if ( defined( 'BIZCITY_KG_HUB_URL' ) ) {
			$pkg = trailingslashit( BIZCITY_KG_HUB_URL ) . 'assets/';
		} else {
			$base = defined( 'BIZCITY_TWIN_AI_URL' )
				? BIZCITY_TWIN_AI_URL
				: plugins_url( '/', dirname( __FILE__, 4 ) . '/bizcity-twin-ai.php' );
			$pkg  = $base . 'core/kg-hub/assets/';
		}
