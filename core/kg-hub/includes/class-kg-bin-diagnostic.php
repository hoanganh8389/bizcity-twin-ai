...
class BizCity_KG_Bin_Diagnostic {
	...
	private function inspect_chunk( $chunk_id ) {
		...
		echo '<li><code>BizCity_KG_Facade::on_legacy_chunks_persisted()</code> — core/kg-hub/includes/class-kg-facade.php (mirror from legacy webchat/doc)</li>';
		echo '<li><code>BizCity_KG_Source_Service</code> ingest helpers — core/kg-hub/includes/class-kg-source-service.php</li>';
		echo '<li><code>BizCity_KG_Backfill_Driver</code> — core/kg-hub/includes/backfill/class-driver.php (one-shot migration)</li>';
	...
	private function code_has_json_fallback() {
		$retriever = WP_PLUGIN_DIR . '/bizcity-twin-ai/core/kg-hub/includes/class-kg-retriever.php';
