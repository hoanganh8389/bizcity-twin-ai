import{g as j,s as J,a as Q,b as Y,q as tt,p as et,c as s,l as w,d as at,G as it,K as rt,L as st,M as G,e as ot,z as nt,N as lt,H as ct}from"./vendor-mermaid-Dh_u8o6u.js";import{p as dt}from"./chunk-4BX2VUAB-CGvgVA9I.js";import{p as pt}from"./wardley-RL74JXVD-UacqU81E.js";import{o as gt}from"./vendor-graph-C2U_okeF.js";import"./vendor-query-CmcMXlZA.js";var ht=ct.pie,C={sections:new Map,showData:!1},u=C.sections,D=C.showData,ut=structuredClone(ht),ft=s(()=>structuredClone(ut),"getConfig"),mt=s(()=>{u=new Map,D=C.showData,nt()},"clear"),vt=s(({label:t,value:a})=>{if(a<0)throw new Error(`"${t}" has invalid value: ${a}. Negative values are not allowed in pie charts. All slice values must be >= 0.`);u.has(t)||(u.set(t,a),w.debug(`added new section: ${t}, with value: ${a}`))},"addSection"),xt=s(()=>u,"getSections"),St=s(t=>{D=t},"setShowData"),wt=s(()=>D,"getShowData"),L={getConfig:ft,clear:mt,setDiagramTitle:et,getDiagramTitle:tt,setAccTitle:Y,getAccTitle:Q,setAccDescription:J,getAccDescription:j,addSection:vt,getSections:xt,setShowData:St,getShowData:wt},Ct=s((t,a)=>{dt(t,a),a.setShowData(t.showData),t.sections.map(a.addSection)},"populateDb"),Dt={parse:s(async t=>{const a=await pt("pie",t);w.debug(a),Ct(a,L)},"parse")},$t=s(t=>`
  .pieCircle{
