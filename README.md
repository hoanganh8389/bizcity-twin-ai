# Bizcity Twin AI — Bộ Não Thứ 2 Cho Doanh Nghiệp | The Second Brain for Business

> **VI**: Bizcity Twin AI biến WordPress thành **Bộ não thứ 2** của doanh nghiệp, được doanh nghiệp chủ động đào tạo bằng chính tri thức nội bộ để vận hành CRM, content, marketing, chăm sóc khách hàng và automation.
>
> **EN**: Bizcity Twin AI turns WordPress into your business **Second Brain**, trained by your own knowledge to run CRM, content, marketing, customer care, and automation workflows.
...
**Second Brain · Graph RAG · WordPress-native · Open Source · Free Core**
...
## 2) 6 Giá trị lớn của mã nguồn | Six Strategic Values
...
## 4) Bộ công cụ tích hợp | Integrated Business Tooling

| Tooling | Vai trò (VI) | Role (EN) |
|---|---|---|
| Graph RAG + KG Hub | Trung tâm tri thức và suy luận theo quan hệ | Central knowledge and relation-aware reasoning core |
| Twin CRM (`plugins/bizcity-twin-crm`) | Vận hành CRM, lead pipeline, campaign funnel | CRM operations, lead pipeline, campaign funnels |
| Twin Channel Gateway (`core/channel-gateway`) | Kết nối Zalo OA, Facebook, Messenger, Zalo Bot, webchat | Channel operations across Zalo OA, Facebook, Messenger, Zalo Bot, webchat |
| Bizcoach-pro (`plugins/bizcoach-pro`) | Phân tích hồ sơ nhân sự và năng lực phối hợp | People profile analysis and collaboration-fit insights |
| Automation + Scheduler (`core/automation`, `core/scheduler`) | Tự động hóa quy trình, báo cáo và trigger vận hành | Workflow automation, reporting, and trigger-driven operations |
| Content stack (`plugins/bizcity-content-creator`, `plugins/bizcity-doc`, `plugins/bizcity-tool-image`) | Sản xuất content marketing, tài liệu, hình ảnh | Marketing content, documents, and visual asset generation |

---

## 5) Doanh nghiệp dùng Twin AI như thế nào? | How Businesses Use Twin AI

- **CRM và chăm sóc khách hàng | CRM & customer care**: Đồng bộ tri thức sản phẩm và lịch sử trao đổi để phản hồi đúng ngữ cảnh trên các kênh.
- **Marketing và content | Marketing & content**: Tạo nội dung campaign, bài viết, tài liệu bán hàng dựa trên tri thức được doanh nghiệp huấn luyện.
- **Vận hành nội bộ | Internal operations**: Tự động giao việc, nhắc việc, tổng hợp KPI, gửi báo cáo qua trợ lý.
- **Quản trị nhân sự | People management**: Phân tích điểm mạnh/điểm yếu và khả năng phối hợp để tối ưu đội ngũ.

---

## 6) Kiến trúc tổng quan | High-Level Architecture

```text
                    +------------------------------------+
                    |   KG Hub (Graph RAG + Memory)     |
                    +----------------+-------------------+
                                     |
         +---------------------------+----------------------------+
         |                           |                            |
 +-------v--------+         +--------v---------+         +--------v--------+
 | Twin CRM       |         | Channel Gateway  |         | Automation      |
 | Leads/Funnels  |         | Zalo/FB/MSG/Bot  |         | Scheduler/Tasks |
 +-------+--------+         +--------+---------+         +--------+--------+
         |                           |                            |
         +---------------------------+----------------------------+
                                     |
...
## 7) Mã nguồn mở và Free Core | Open Source and Free Core

**VI**
Dự án được phát hành theo GPL-2.0-or-later và hướng tới mô hình sử dụng **mã nguồn mở, free core** cho doanh nghiệp triển khai Bộ não thứ 2 trên WordPress của chính mình.

**EN**
This project is released under GPL-2.0-or-later and follows an **open-source, free-core** model so businesses can self-host their Second Brain on their own WordPress stack.

---

## 8) Pháp lý và sở hữu trí tuệ | Legal and IP Notice

**VI**
- Đã bảo hộ Trademark: **Bizcity** và **Bizcoach**.
- Đã đăng ký bản quyền tác giả cho mô hình **mạng lưới não song sinh số** cùng bộ công cụ CRM, POS, content marketing, quản trị nhân sự và các nghiệp vụ chuyển đổi số liên quan.

**EN**
- Protected trademarks: **Bizcity** and **Bizcoach**.
- Author copyright registration has been declared for the **Digital Twin Brain Network** model and related toolchain (CRM, POS, content marketing, HR management, and digital operations).
...
├── bizcity-twin-ai.php
├── core/
│   ├── knowledge/          # KG Hub + Graph RAG
│   ├── memory/             # Multi-layer memory federation
│   ├── intent/             # Intent orchestration
│   ├── channel-gateway/    # Multi-channel operations
...
## 10) Cài đặt nhanh | Quick Start

### Requirements
- WordPress 6.0+
- PHP 7.4+
- MySQL 5.7+
- BizCity API key: [bizcity.vn/my-account](https://bizcity.vn/my-account/)
...
`WP Admin -> BizCity AI -> LLM Settings -> Add API key -> Test`

---

## 11) Cộng đồng và hỗ trợ | Community and Support
...
## 12) Bản quyền, liên hệ | License and Contact

- License: GPL-2.0-or-later
- Author: Johnny Chu (Chu Hoàng Anh)
- Contact: Hoanganh.itm@gmail.com | +84 931 576 886

> **VI**: Tương lai chuyển đổi số là khi doanh nghiệp không chỉ dùng AI để trả lời, mà dùng AI như bộ não vận hành thứ 2 được huấn luyện bằng tri thức riêng của mình.
>
> **EN**: The future of digital operations is not using AI as a chatbot, but running AI as a trained second operating brain built from your own business knowledge.
