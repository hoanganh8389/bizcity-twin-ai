 ...
 *
 * A one-off operator tool, never loaded by any bootstrap. Run with WP-CLI:
 *   wp eval-file wp-content/plugins/bizcity-twin-ai/bin/seed-knowledge-skills.php
 *
 * It writes through BizCity_Skill_Database, whose canonical owner is
 * `core/skills` — this script only calls that public API.
 *
 * [2026-09-24 Claude Opus 5] CORE-REDUCTION-WP-01 K-04 — moved here from
 * core/knowledge/includes/skill-seeder.php. Reusable scripts live in bin/ so a
 * module directory carries only code the runtime actually loads.
 *
