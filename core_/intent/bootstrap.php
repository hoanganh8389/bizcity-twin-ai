...
add_action( 'plugins_loaded', function () {
    ...
    // Memory services (Rolling + Episodic)
...
if ( ! function_exists( 'bizcity_intent_process' ) ) {
    /**
     * Process a message through the Intent Engine.
     *
     * Can be called from any channel (AJAX, Zalo hook, Telegram, etc.).
     *
     * @param array $params
     * @return array
     */
    function bizcity_intent_process( array $params ) {
        return BizCity_Intent_Engine::instance()->process( $params );
    }
}
