...
if ( ! defined( 'BIZCITY_TWIN_CORE_VERSION' ) ) {
    define( 'BIZCITY_TWIN_CORE_VERSION', '2.0.0' );
}
...
// DB table + cron + AJAX
BizCity_Memory_Table_Migration::maybe_migrate();  // Rename memory tables → bizcity_memory_*
