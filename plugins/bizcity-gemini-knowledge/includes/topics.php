<?php
/**
 * Topics & suggested questions for Gemini Knowledge.
 *
...
/**
 * Get all knowledge topics with categories and suggested questions.
 */
function bzgk_get_topics() {
    return [
        [
 ...
 */
function bzgk_get_topics_grouped() {
