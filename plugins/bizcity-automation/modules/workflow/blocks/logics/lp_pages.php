...
class WaicLogic_lp_pages extends WaicLogic {
	protected $_code = 'lp_pages';
	protected $_subtype = 3;
	protected $_order = 1;
	
	public function __construct( $block = null ) {
		$this->_name = __('Search Pages', 'ai-copilot-content-generator');
		$this->_desc = __('Repeat actions for multiple Pages', 'ai-copilot-content-generator');
	...
	public function setSettings() {
		...
		$this->_settings = array(
			...
			'title' => array(
				'type' => 'input',
				'label' => __('Page Title contains', 'ai-copilot-content-generator'),
				'default' => '',
				'variables' => true,
			),
			'body' => array(
				'type' => 'input',
				'label' => __('Page Body contains', 'ai-copilot-content-generator'),
				'default' => '',
				'variables' => true,
			),
			'date_mode' => array(
				'type' => 'select',
				'label' => __('Page Date', 'ai-copilot-content-generator'),
				'default' => '',
				'options' => array(
					'' => '',
	...
	public function setVariables() {
		$this->_variables = array(
			'count_steps' => __('Total Number of Pages', 'ai-copilot-content-generator'),
			...
			'loop_vars' => array_merge(array('step' => __('Step', 'ai-copilot-content-generator')), $this->getPageVariables()),
		);
		return $this->_variables;
	}
	...
	public function addLoopVariables( $step, $workflow ) {
		...
		if (!empty($id)) {
			$variables = $workflow->addPageVariables($variables, $id);
		}
		return $variables;
	}
