...
class WaicAction_ai_perplexity_generate_text extends WaicAction {
	protected $_code = 'ai_perplexity_generate_text';
	protected $_order = 6;
	
	public function __construct( $block = null ) {
		$this->_name = __('Perplexity Generate Text', 'ai-copilot-content-generator');
		$this->_desc = __('Perplexity text generation', 'ai-copilot-content-generator');
	...
	public function setSettings() {
		...
		$this->_settings = array(
			...
			'model' => array(
				...
				'default' => $modelOptions->getDefaults('api', 'perplexity_model'),
				'options' => $modelOptions->getVariations('api', 'model', 'perplexity'),
			),
			'tokens' => array(
				'type' => 'number',
	...
	public function getResults( $taskId, $variables, $step = 0 ) {
		$apiOptions = array(
			'engine' => 'perplexity',
			'perplexity_model' => $this->getParam('model'),
