...
class WaicAction_ai_deepseek_generate_text extends WaicAction {
	protected $_code = 'ai_deepseek_generate_text';
	protected $_order = 4;
	
	public function __construct( $block = null ) {
		$this->_name = __('DeepSeek Generate Text', 'ai-copilot-content-generator');
		$this->_desc = __('DeepSeek text generation', 'ai-copilot-content-generator');
	...
	public function setSettings() {
		...
		$this->_settings = array(
			...
			'model' => array(
				...
				'default' => $modelOptions->getDefaults('api', 'deep_seek_model'),
				'options' => $modelOptions->getVariations('api', 'model', 'deep-seek'),
			),
			'tokens' => array(
				'type' => 'number',
	...
	public function getResults( $taskId, $variables, $step = 0 ) {
		$apiOptions = array(
			'engine' => 'deep-seek',
			'deep_seek_model' => $this->getParam('model'),
