...
class WaicAction_ai_generate_text extends WaicAction {
	protected $_code = 'ai_generate_text';
	protected $_order = 0;
	
	public function __construct( $block = null ) {
		$this->_name = __('Open AI Generate Text', 'ai-copilot-content-generator');
		$this->_desc = __('GPT text generation', 'ai-copilot-content-generator');
