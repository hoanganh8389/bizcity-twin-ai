...
class WaicTrigger_wp_media_updated extends WaicTrigger {
	protected $_code = 'wp_media_updated';
	protected $_hook = 'edit_attachment';
	protected $_subtype = 2;
	protected $_order = 31;
	
	public function __construct( $block = null ) {
		$this->_name = __('Media updated', 'ai-copilot-content-generator');
	...
	public function controlRun( $args = array() ) {
		...
		if (!empty($alt)) {
			...
			if (WaicUtils::mbstrpos($altText, $alt) === false) {
				return false;
			}
		}
