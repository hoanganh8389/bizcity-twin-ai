...
class WaicTrigger_wp_comment_created extends WaicTrigger {
	protected $_code = 'wp_comment_created';
	protected $_hook = 'comment_post';
	protected $_subtype = 2;
	protected $_order = 20;
	
	public function __construct( $block = null ) {
		$this->_name = __('Comment Created', 'ai-copilot-content-generator');
