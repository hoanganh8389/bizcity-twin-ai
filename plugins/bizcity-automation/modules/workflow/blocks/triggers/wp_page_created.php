...
class WaicTrigger_wp_page_created extends WaicTrigger {
	protected $_code = 'wp_page_created';
	protected $_hook = 'wp_after_insert_post';
	protected $_subtype = 2;
	protected $_order = 10;
	
	public function __construct( $block = null ) {
		$this->_name = __('Page created', 'ai-copilot-content-generator');
	...
	public function setSettings() {
		...
		$statuses = array_merge(array('' => ''), get_page_statuses());
