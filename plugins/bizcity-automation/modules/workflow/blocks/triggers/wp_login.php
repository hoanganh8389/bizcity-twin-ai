...
class WaicTrigger_wp_login extends WaicTrigger {
	protected $_code = 'wp_login';
	protected $_hook = 'wp_login';
	protected $_subtype = 2;
	protected $_order = 1;
	
	public function __construct( $block = null ) {
		$this->_name = __('User logged in', 'ai-copilot-content-generator');
	...
	public function setVariables() {
		$this->_variables = array_merge($this->getDTVariables(), $this->getUserVariables());
		return $this->_variables;
	}
