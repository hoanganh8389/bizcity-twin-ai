...
/* =====================================================================
 * PHASE-0.2 Sprint G.4 — Deprecation notice (WP_DEBUG only).
 *
 * Direct Prokerala calls bypass the bizcity-llm-router gateway and are
 * deprecated. Use BizCoach_Pro_Astro_Client::* sugar methods instead.
 * Suppressible via filter `bcpro_silence_legacy_astro_deprecations`.
 * =====================================================================*/
if ( defined( 'WP_DEBUG' ) && WP_DEBUG && ! defined( 'BCCM_PROKERALA_DEPRECATED_NOTICE_SHOWN' ) ) {
    define( 'BCCM_PROKERALA_DEPRECATED_NOTICE_SHOWN', true );
    if ( ! ( function_exists( 'apply_filters' ) && apply_filters( 'bcpro_silence_legacy_astro_deprecations', false ) ) ) {
        @trigger_error( '[bizcoach-pro][G.4] astro-api-prokerala.php is DEPRECATED — migrate callers to BizCoach_Pro_Astro_Client.', E_USER_DEPRECATED );
    }
}
